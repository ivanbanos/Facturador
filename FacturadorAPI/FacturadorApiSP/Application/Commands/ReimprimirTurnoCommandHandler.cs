...
{
    public class ReimprimirTurnoCommandHandler : IRequestHandler<ReimprimirTurnoCommand,string>
    {
        ...
        public async Task<string> Handle(ReimprimirTurnoCommand request, CancellationToken cancellationToken)
        {
