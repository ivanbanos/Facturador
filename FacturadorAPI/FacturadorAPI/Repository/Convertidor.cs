...
namespace FacturadorAPI.Repository
{
    public static class Convertidor
    {
        ...
        public static List<FacturaCanastilla> ConvertirFacturaCanastilla(this DataTable dt)
        {
        ...
        public static List<CanastillaFactura> ConvertirFacturaCanastillaDEtalle(this DataTable dt)
        {
